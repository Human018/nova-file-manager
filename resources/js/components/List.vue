...
import { Menu, MenuButton, MenuItem, MenuItems, RadioGroup, RadioGroupOption, } from '@headlessui/vue'
...
export default {
  ...
  mutations: ['setSelectedFile'],

  states: ['files', 'directories', 'selectedFile'],
